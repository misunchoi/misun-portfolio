        ...
        >
          <div class="card text-white bg-primary mb-3" style={{ maxWidth: '20rem', margin: 'auto'}}>
            ...
            <div class="card-body">
              ...
              <p class="card-text">Created the layout, header, footer, and Start Serving page. Implemented AWS Simple Email Service (SES). Visit the website <a style={{ color: 'white' }} href="http://gnd-website.s3-website-us-east-1.amazonaws.com">here.</a></p>
